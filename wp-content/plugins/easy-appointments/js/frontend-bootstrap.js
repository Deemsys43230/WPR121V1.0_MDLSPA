    ...
    jQuery.extend(Plugin.prototype, {
        ...
        finalComformation: function (event) {
            ...
            var req = jQuery.get(ea_ajaxurl, options, function (response) {
                ...
                plugin.$element.find('form').find('#error-message').hide();
            ...
            .fail(jQuery.proxy(function (response, status, error) {
               ...
               // this.$element.find('#error-message').append(response.responseJSON.message);
        ...
        singleConformation: function (event) {
         ...
         //to empty error message
            ...
            this.$element.find('.ea-submit').prop('disabled', true);
            this.$element.find('.ea-cancel').prop('disabled', true);
            ...
            .fail(jQuery.proxy(function (response) {
                ...
                this.$element.find('.ea-submit').prop('disabled', false);
                //to disable cancel button while user submit the details
                this.$element.find('.ea-cancel').prop('disabled', false);
                this.$element.find('#error-message').append(response.responseJSON.message);
               // plugin.scrollToElement(plugin.$element.find('.custom-field'));
        ...
        scrollToElement: function (element) {
            console.log(element)
            if(element.selector =='.date'){
                jQuery('html, body').animate({
                    scrollTop: ( element.offset().top - 20 )
                }, 2000);
            }
            if(element.selector =='.final'){
                jQuery('html, body').animate({
