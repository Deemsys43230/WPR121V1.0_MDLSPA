            ...
            <div class="step final col-md-6">
                ...
                <div class="step final">
                    ...
                    <div class="form-group">
                      <div class="col-sm-5">
                          <label class="control-label"><%= item.label %> <% if (item.required == "1") { %><span class="required-color ">*</span><% }
                              %>  </label>
                      </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="checkbox">
                                <label style="display: inline-grid !important;">
                    ...
                    <div class="form-group col-sm-8" >
                        <span id="error-message" class="invalid-error"></span>
                    </div>
                    <div class="form-group">
